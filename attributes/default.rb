...
# SERVER PLUGINS
default['elasticsearch']['plugins'] = "lukas-vlcek/bigdesk, mobz/elasticsearch-head, karmi/elasticsearch-paramedic"
...
default['elasticsearch']['unicast_hosts'] = ["localhost"]
default['elasticsearch']['unicast'] = false
